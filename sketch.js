...
function setup() {
  ...
  spaceship1 = createSprite(displayWidth / 10, 150);

  spaceship1.addImage(spaceship1Img);

  spaceship1.scale = 1;

  spaceship2 = createSprite(displayWidth / 4, 150);

  spaceship2.addImage(spaceship2Img);

  spaceship2.scale = 1;

  spaceship3 = createSprite(displayWidth / 2.5, 150);
  ...
  endl = createSprite(displayWidth / 2, height / 2 + 500, 2000, 20);
  // endl = createSprite(1000, height / 2 + 500, 2000, 20);
